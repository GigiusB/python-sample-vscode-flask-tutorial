[![Build Status](https://dev.azure.com/gigiusb/test_azure1/_apis/build/status/GigiusB.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/gigiusb/test_azure1/_build/latest?definitionId=1&branchName=master)
